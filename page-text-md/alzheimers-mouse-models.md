...
| Factor | Knockin | Transgenic |
| --- | --- | --- |
| Expression level | Physiological | Supraphysiological |
| Pathology onset | Gradual (12+ months) | Rapid (3 to 6 months) |
| Overexpression artifacts | None | Possible |
| Copy number | Single | Variable |
| Regulatory control | Endogenous | Promoter dependent |
