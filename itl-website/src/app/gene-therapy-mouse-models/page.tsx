...
// FAQ Data
const faqData = [
  { question: "What types of disease models are used for gene therapy testing?", answer: "Gene therapy models include knockout models (loss-of-function diseases), point mutation knockin models (specific disease variants), conditional knockout models (tissue specific disease), and humanized models (testing human gene replacement). Selection depends on disease mechanism and therapeutic strategy (gene replacement, correction, or augmentation)." },
  { question: "How do you validate gene therapy efficacy in mouse models?", answer: "Gene therapy efficacy is validated through functional rescue (behavioral, biochemical, or physiological endpoints), protein expression (Western blot, immunohistochemistry), vector biodistribution (PCR, imaging), safety assessment (toxicity, immune response), and long-term persistence (expression duration, stability)." },
  { question: "Can gene therapy models be combined with reporter systems?", answer: "Yes. Reporter knockins can track gene expression, vector transduction efficiency, and therapeutic transgene expression. GFP or luciferase reporters enable real-time monitoring of gene therapy delivery and expression through imaging or flow cytometry. This is particularly valuable for AAV-based therapies. (/request-quote)" }
];
...
export default function GeneTherapyMouseModelsPage() {
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Gene Therapy Mouse Models",
                "item": "https://www.genetargeting.com/gene-therapy-mouse-models"
              }
            ]
          })
        }}
