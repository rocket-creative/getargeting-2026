...
// FAQ Data
const faqData = [
  { question: "What is the difference between traditional backcrossing and speed congenic?", answer: "Traditional backcrossing takes 10 generations (approximately 2.5 years) to reach 99.9% background purity. Speed congenic uses SNP panel analysis to identify offspring with the highest recipient background content at each generation, reducing the process to 5-7 generations (approximately 1-1.5 years)." },
...
export default function BackcrossingServicesPage() {
