...
// FAQ Data
const faqData = [
  { question: "What types of rheumatoid arthritis mouse models are available?", answer: "RA models include spontaneous models (K/BxN serum transfer, collagen-induced arthritis), gene-targeted models (knockout or knockin of RA susceptibility genes), and conditional models (tissue specific deletion of genes involved in RA pathogenesis). Selection depends on research question, timeline, and specific mechanisms of interest." },
  { question: "What Cre drivers are used for RA studies?", answer: "Common Cre drivers include CD4-Cre (T lymphocytes), LysM-Cre (macrophages and neutrophils), CD11c-Cre (dendritic cells), and CX3CR1-Cre (monocytes/macrophages). Selection depends on whether you're studying T-cell contributions, macrophage function, or combined immune mechanisms in RA." },
  { question: "How do you phenotype rheumatoid arthritis mouse models?", answer: "RA phenotyping includes clinical assessment (paw swelling, arthritis score, joint inflammation), histological analysis (synovial inflammation, cartilage damage, bone erosion, pannus formation), serum biomarkers (rheumatoid factor, anti-CCP antibodies, inflammatory cytokines), and functional assessment (grip strength, mobility)." },
  { question: "Can RA models be combined with environmental triggers?", answer: "Yes. Genetic modifications can be combined with environmental factors (collagen immunization, serum transfer, adjuvant) to model gene-environment interactions in RA. Conditional approaches enable study of how specific genes contribute to RA pathogenesis in controlled challenge protocols." }
];
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Rheumatoid Arthritis Mice",
                "item": "https://www.genetargeting.com/rheumatoid-arthritis-mice"
              }
            ]
          })
        }}
