...
// FAQ Data
const faqData = [
  { question: "What types of reporter knockins are used for biomarker discovery?", answer: "Common reporter knockins include fluorescent proteins (GFP, mCherry), luciferase for bioluminescence imaging, and epitope tags (HA, FLAG) for protein detection. Reporters can be knocked into endogenous loci to track gene expression or fused to proteins of interest for localization studies." },
  { question: "Can you create inducible reporter systems for temporal biomarker tracking?", answer: "Yes. Inducible Cre (CreER) systems enable temporal control of reporter expression. TRE-based systems (tetracycline-responsive) provide reversible control. These systems enable tracking of biomarker expression at specific disease timepoints or in response to treatments." },
  { question: "How do you validate reporter expression in biomarker models?", answer: "Pre-germline characterization includes Southern blot analysis to confirm correct targeting and single-copy integration. Flow cytometry, immunohistochemistry, or Western blot confirms reporter expression and proper localization. Functional validation ensures reporter faithfully reflects endogenous gene expression." },
  { question: "Can biomarker models be combined with disease models?", answer: "Yes. Reporter knockins can be combined with disease models (knockouts, point mutations) to track biomarker expression in disease context. For example, reporter knockin combined with conditional knockout enables tracking of biomarker-expressing cells during disease progression or treatment response." }
];
    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <main id="main-content">
        ...
        <section style={{ backgroundColor: '#f8f9fa', padding: '60px 20px' }}>
          <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
            <LabSignalsSignup title="Biomarker Discovery Research Insights" />
          </div>
        </section>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Biomarker Discovery Mice",
                "item": "https://www.genetargeting.com/biomarker-discovery-mice"
              }
            ]
          })
        }}
