...
export const metadata: Metadata = {
  title: 'Cdna Knockin | ingenious targeting laboratory',
  description: 'Cdna Knockin from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
  alternates: {
    canonical: 'https://www.genetargeting.com/cdna-knockin',
  },
  openGraph: {
    title: 'Cdna Knockin | ingenious targeting laboratory',
    description: 'Cdna Knockin from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
    url: 'https://www.genetargeting.com/cdna-knockin',
...
export const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Cdna Knockin", item: "https://www.genetargeting.com/cdna-knockin" }
  ],
};
