...
// FAQ Data
const faqData = [
  { question: "What are the key differences between C57BL/6J and C57BL/6N substrains?", answer: "C57BL/6J carries a mutation in the Nnt (nicotinamide nucleotide transhydrogenase) gene affecting glucose metabolism. C57BL/6N does not have this mutation. Substrains differ in some behavioral phenotypes, seizure susceptibility, and responses to metabolic challenges. C57BL/6N ES cells (JM8 lines) are standard for gene targeting." },
...
export default function C57bl6jVsC57bl6nPage() {
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "C57bl6j vs C57bl6n",
                "item": "https://www.genetargeting.com/c57bl6j-vs-c57bl6n"
              }
            ]
          })
        }}
