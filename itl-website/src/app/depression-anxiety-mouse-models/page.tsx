...
// FAQ Data
const faqData = [
  { question: "Which behavioral test best identifies depression like phenotypes?", answer: "Forced swim test shows good sensitivity to antidepressant treatment and discriminates genetic depression models from controls. Combining forced swim with anhedonia assessment through sucrose preference provides more comprehensive depression phenotyping than either test alone." },
  { question: "How long must chronic stress be applied to produce depression-like phenotypes?", answer: "Chronic unpredictable stress for 4 to 6 weeks typically produces robust depression phenotypes including anhedonia and behavioral despair. Shorter stress periods produce acute anxiety and stress responses with limited depression relevant features." },
  { question: "Can antidepressant efficacy be assessed in anxiety models?", answer: "Antidepressants show anxiolytic effects in anxiety tests though effects develop more slowly than anxiety medications. Chronic antidepressant administration (2 to 4 weeks) necessary for full anxiolytic efficacy, matching clinical antidepressant onset timing." },
  { question: "What is the translational validity of mouse depression models?", answer: "Depression models show good pharmacological predictive validity with antidepressant sensitive effects in validated tests. Construct validity regarding biological mechanisms remains moderate given simplified neurobiology compared to human psychiatric disease." },
  { question: "Can depression models be used for screening novel therapeutics?", answer: "Yes, validated depression models enable preclinical screening of novel compounds. Combining genetic and stress models with comprehensive behavioral testing provides mechanism-of-action insight beyond simple behavioral measures." }
];

// Related Links
const relatedLinks: Array<{ title: string; href: string }> = [];

export default function DepressionAnxietyMouseModelsPage() {
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Depression Anxiety Mouse Models",
                "item": "https://www.genetargeting.com/depression-anxiety-mouse-models"
              }
            ]
          })
        }}
