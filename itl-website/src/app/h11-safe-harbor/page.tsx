...
const faqData = [
  ...
  { question: "Does H11 integration affect nearby genes?", answer: "H11 locus integration occurs in an extensive intergenic region distant from annotated genes, minimizing risk of insertional mutagenesis. Characterization studies have not identified disrupted gene expression patterns in H11 transgenic models, suggesting genomic position does not disrupt nearby regulatory regions." }
];

// Related Links
const relatedLinks: Array<{ title: string; href: string }> = [];

export default function H11SafeHarborPage() {
      ...
      <main id="main-content">
        ...
        <section style={{ backgroundColor: '#f8f9fa', padding: '50px 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <LabSignalsSignup 
              variant="card"
              title="Safe Harbor Locus Updates"
              description="Learn about genomic integration strategies, transgene expression, and targeting techniques from PhD scientists."
            />
          </div>
        </section>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "H11 Safe Harbor",
                "item": "https://www.genetargeting.com/h11-safe-harbor"
              }
            ]
          })
        }}
