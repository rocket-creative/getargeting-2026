/**
 * Type 2 Diabetes Mouse Models Page
...
// FAQ Data
const faqData = [
  { question: "What is the best mouse strain for type 2 diabetes studies?", answer: "C57BL/6J strain develops robust diet-induced obesity and type 2 diabetes phenotypes with high penetrance and rapid disease onset. BTBR+tf/J strain shows even greater metabolic sensitivity. Strain selection depends on specific research question and pathway investigation focus." },
  { question: "How long does diet-induced obesity take to develop type 2 diabetes?", answer: "High fat diet feeding typically produces measurable insulin resistance within 4 to 8 weeks and overt glucose intolerance by 12 to 16 weeks. Timeline varies with strain genetics, diet composition, and starting age." },
  { question: "Can db/db mice be used for therapeutic testing?", answer: "Yes, db/db mice show good pharmacological response to antidiabetic drugs. However, monogenic obesity origins limit relevance to polygenetic human type 2 diabetes. DIO models may better represent human disease polygenic nature." },
  { question: "What metabolic readouts best capture type 2 diabetes progression?", answer: "Glucose tolerance combined with insulin tolerance testing and adiposity assessment provide comprehensive type 2 diabetes phenotyping. Metabolic cage analysis reveals energy expenditure contributions. Islet function assessment reveals beta cell specific defects." },
  { question: "Can conditional knockout be used for tissue specific diabetes investigation?", answer: "Yes, tissue specific conditional knockouts enable investigation of pathway specific contributions. Liver-specific knockouts reveal hepatic glucose production abnormalities, while muscle-specific knockouts reveal peripheral insulin resistance mechanisms." }
];

// Related Links
const relatedLinks: Array<{ title: string; href: string }> = [];

export default function Type2DiabetesMicePage() {
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Type 2 Diabetes Mice",
                "item": "https://www.genetargeting.com/type-2-diabetes-mice"
              }
            ]
          })
        }}
