...
export const metadata = {
  title: 'Search | ingenious targeting laboratory',
  description: 'Search for mouse models, services, and resources.',
};
  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <main id="main-content" style={{ minHeight: '60vh', padding: '80px 20px', textAlign: 'center' }}>
        <h1 style={{ fontSize: '2.5rem', color: '#0a253c', marginBottom: '20px' }}>Search</h1>
