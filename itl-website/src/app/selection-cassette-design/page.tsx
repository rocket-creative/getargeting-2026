/**
 * Selection Cassette Design - Placeholder Page
...
export const metadata = {
  title: 'Selection Cassette Design | ingenious targeting laboratory',
  description: 'Selection cassette design for gene targeting vectors.',
};
