...
const faqData = [
  ...
  { question: "Can I convert a conventional knockout to a conditional knockout later?", answer: "If the knockout was generated using a knockout-first allele design, yes. Flp recombinase converts it to a conditional-ready allele. If the knockout was generated by simple exon deletion without the cassette system, a new conditional targeting project would be required." }
];
