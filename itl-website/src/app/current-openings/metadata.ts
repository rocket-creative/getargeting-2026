...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.genetargeting.com/current-openings',
  },
  openGraph: {
    title: 'Current Openings | ingenious targeting laboratory',
    description: 'Current Openings from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
    url: 'https://www.genetargeting.com/current-openings',
...
export const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Current Openings", item: "https://www.genetargeting.com/current-openings" }
  ],
};
