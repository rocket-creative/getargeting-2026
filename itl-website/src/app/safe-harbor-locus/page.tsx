/**
 * Safe Harbor Locus Integration Strategies Page
...
// FAQ Data
const faqData = [
  { question: "What is a safe-harbor locus and why is it important?", answer: "Safe-harbor loci are genomic locations that support transgene integration without disrupting endogenous gene function or causing position effects. Rosa26, H11, and HPRT are well-characterized safe-harbor loci that provide predictable, stable transgene expression with minimal variability between founder lines." },
  { question: "What are the advantages of using safe-harbor loci vs random integration?", answer: "Safe-harbor integration provides single-copy integration at a defined location, predictable expression patterns, minimal position effects, and reproducible results across founder lines. Random integration can cause variable copy numbers, position effects, disruption of endogenous genes, and inconsistent expression." },
  { question: "Which safe-harbor locus should I use?", answer: "Rosa26 is the most widely used safe-harbor locus, providing ubiquitous expression suitable for most applications. H11 provides an alternative with similar properties. HPRT is used for specific applications. Selection depends on expression requirements, construct size, and experimental goals." },
  { question: "Can safe-harbor loci be used for conditional expression?", answer: "Yes. Safe-harbor loci can accommodate conditional expression cassettes including LoxP-stop-LoxP for Cre-dependent expression, TRE-driven systems for doxycycline control, and other inducible systems. The safe-harbor provides the integration site; expression control depends on construct design. (/request-quote) Last Updated: December 23, 2025" }
];

// Related Links
const relatedLinks: Array<{ title: string; href: string }> = [];

export default function SafeHarborLocusPage() {
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": "https://www.genetargeting.com/safe-harbor-locus"
              }
            ]
          })
        }}
