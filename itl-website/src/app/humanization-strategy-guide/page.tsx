/**
 * Humanization Strategy Guide Page
...
// FAQ Data
const faqData = [
  { question: "When should full replacement be chosen over domain humanization?", answer: "Full replacement optimizes for human protein function accuracy when mouse-human protein homology is high (>85%) and therapeutic objective requires complete human behavior. Domain humanization provides better compromise when discrete epitopes or catalytic regions require human specificity while supporting physiological integration." },
  { question: "Can humanized models be validated before mouse generation?", answer: "Transient expression in cell culture and humanized protein transfection into appropriate cell systems enables preliminary functional characterization. However, in vivo validation requires actual humanized mice confirming expression, localization, and physiological function." },
  { question: "What percentage of humanized mice show appropriate functional outcomes?", answer: "Approximately 60 to 80% of humanized lines show expected functional phenotypes. Unexpected outcomes reflect inefficient expression, inappropriate splicing, intracellular mislocalization, or unanticipated species-specific interaction differences. Multiple independent lines increase likelihood of identifying appropriately humanized founder." },
  { question: "Can transgenic humanized models be as effective as gene replacement?", answer: "Transgenic humanized models frequently show superior expression control compared to gene replacement since transgene dosage is independent of endogenous gene control. However, endogenous mouse gene expression may complicate interpretations through redundant human-mouse function. Combination of knockdown or knockout of mouse gene plus transgenic human expression optimizes humanized model design." },
  { question: "How do humanized models affect disease relevant phenotypes?", answer: "Humanized models often show modified disease phenotypes compared to conventional models due to species-specific pathway interactions. Some humanized models show enhanced or reduced disease severity requiring empirical determination of disease manifestation in humanized context." }
];

// Related Links
const relatedLinks: Array<{ title: string; href: string }> = [];

export default function HumanizationStrategyGuidePage() {
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Humanization Strategy Guide",
                "item": "https://www.genetargeting.com/humanization-strategy-guide"
              }
            ]
          })
        }}
