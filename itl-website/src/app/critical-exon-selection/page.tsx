...
const publicationsData = [
  {
    ...
    journal: "Nature 474(7351): 337 to 342"
  },
  {
    authors: "Gondo Y.",
    year: "2008",
    title: "Trends in large scale mouse mutagenesis: from phenotype driven to gene driven research.",
    journal: "Nature Reviews Genetics 9(11): 803 to 810"
  },
  {
    authors: "Friedel RH, Soriano P.",
    year: "2010",
    title: "Gene trap mutagenesis in the mouse.",
    journal: "Methods in Molecular Biology 693: 43 to 63"
  }
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="hero-animate">
                <div style={{
                  ...
                  <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: '.8rem', marginTop: '10px' }}>Exon Selection Diagram</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {deletionTypes.map((item, index) => (
                <div key={index} className="animate-in" style={{ backgroundColor: 'white', padding: '30px', borderRadius: '8px', borderTop: '4px solid ' + (index === 0 ? '#008080' : '#2384da') }}>
          ...
          <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {validationSteps.map((item, index) => (
                <div key={index} className="animate-in" style={{ backgroundColor: 'white', padding: '25px', borderRadius: '8px' }}>
