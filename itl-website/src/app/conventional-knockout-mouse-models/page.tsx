...
import { IconDNA, IconTarget, IconFlask, IconSettings, IconImage, IconQuote, IconChevronRight, IconCheckCircle, IconX } from '@/components/UXUIDC/Icons';
...
const publicationsData = [
  ...
  {
    authors: "Shaikh K, Bowman M, McCormick SM, Gao L, Zhang J, White J, et al.",
    year: "2025",
    title: "ZFAND6 promotes TRAF2-dependent mitophagy to restrain cGAS-STING signaling.",
    journal: "iScience 1(28): 111544"
  },
  {
    authors: "Sabui S, Anthonymuthu S, Ramamoorthy K, Skupsky J, Jennings TSK, et al.",
    year: "2024",
    title: "Effect of knocking out mouse Slc44a4 on colonic uptake of thiamine pyrophosphate.",
    journal: "Am J Physiol Gastrointest Liver Physiol 327(1): G36-G46"
  }
];

// Testimonial Data
const testimonialData = {
  quote: "The Hephaestin model has been so successful that our colony has recently expanded to different laboratories, generating eight research publications thus far. We were impressed with the knowledge and attention to detail of the gene targeting team.",
