...
export const metadata: Metadata = {
  title: 'Phenotyping Services | ingenious targeting laboratory',
  description: 'Phenotyping Services from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
  alternates: {
    canonical: 'https://www.genetargeting.com/phenotyping-services',
  },
  openGraph: {
    title: 'Phenotyping Services | ingenious targeting laboratory',
    description: 'Phenotyping Services from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
    url: 'https://www.genetargeting.com/phenotyping-services',
...
export const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Phenotyping Services", item: "https://www.genetargeting.com/phenotyping-services" }
  ],
};
