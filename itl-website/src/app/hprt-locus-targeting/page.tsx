...
export default function HprtLocusTargetingPage() {
      ...
      <main id="main-content">
        ...
        <section style={{ backgroundColor: '#f8f9fa', padding: '50px 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <LabSignalsSignup 
              variant="card"
              title="Gene Targeting Insights"
              description="Expert analysis of targeting strategies, safe harbor loci, and transgene expression from PhD scientists."
            />
          </div>
        </section>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Hprt Locus Targeting",
                "item": "https://www.genetargeting.com/hprt-locus-targeting"
              }
            ]
          })
        }}
