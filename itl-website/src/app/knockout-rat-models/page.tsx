/**
 * Knockout Rat Models - Placeholder Page
...
export const metadata = {
  ...
  description: 'Custom knockout rat models for research.',
};

export default function KnockoutRatModelsPage() {
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      <UXUIDCNavigation />
      <main id="main-content" style={{ minHeight: '60vh', padding: '80px 20px', textAlign: 'center' }}>
        <h1 style={{ fontSize: '2.5rem', color: '#0a253c', marginBottom: '20px' }}>Knockout Rat Models</h1>
