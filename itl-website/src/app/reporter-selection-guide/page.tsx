      ...
      <main id="main-content">
        ...
        <section style={{ backgroundColor: '#f8f9fa', padding: '50px 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <LabSignalsSignup 
              variant="card"
              title="Reporter System Insights"
              description="Learn about reporter genes, visualization techniques, and lineage tracing strategies from expert PhD scientists."
            />
          </div>
        </section>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Reporter Selection Guide",
                "item": "https://www.genetargeting.com/reporter-selection-guide"
              }
            ]
          })
        }}
