/**
 * SEO Metadata for Reporter Knockin Models
...
export const metadata: Metadata = {
  title: 'Reporter Knockin Models | ingenious targeting laboratory',
  description: 'Reporter Knockin Models from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
  alternates: {
    canonical: 'https://www.genetargeting.com/reporter-knockin',
  },
  openGraph: {
    title: 'Reporter Knockin Models | ingenious targeting laboratory',
    description: 'Reporter Knockin Models from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
    url: 'https://www.genetargeting.com/reporter-knockin',
...
export const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Reporter Knockin Models", item: "https://www.genetargeting.com/reporter-knockin" }
  ],
};
