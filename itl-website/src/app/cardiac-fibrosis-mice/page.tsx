...
// FAQ Data
const faqData = [
  { question: "What Cre drivers are used for cardiac fibrosis studies?", answer: "Common cardiac Cre drivers include Myh6-Cre (cardiomyocytes), Tcf21-MerCreMer (cardiac fibroblasts, inducible), Postn-Cre (activated fibroblasts), and SM22-Cre (smooth muscle cells). Selection depends on whether you're studying cardiomyocyte responses, fibroblast activation, or myofibroblast function in fibrosis." },
  { question: "How do you model cardiac fibrosis in mice?", answer: "Cardiac fibrosis can be modeled through pressure overload (transverse aortic constriction), myocardial infarction (coronary ligation), or genetic modifications affecting fibroblast activation or extracellular matrix production. Conditional approaches enable tissue specific study of genes involved in fibrosis without systemic effects." },
  { question: "Can you create inducible cardiac fibrosis models?", answer: "Yes. Tamoxifen-inducible Cre (CreER) enables temporal control of gene deletion in cardiac fibroblasts or cardiomyocytes, allowing study of adult-onset fibrosis mechanisms without developmental effects. This is particularly useful for genes with essential developmental functions." }
];
    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <main id="main-content">
        ...
        <section style={{ backgroundColor: '#f8f9fa', padding: '60px 20px' }}>
          <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
            <LabSignalsSignup 
              title="Stay Updated on Cardiac Fibrosis Research"
              description="Get the latest insights on myocardial remodeling, fibroblast biology, and anti-fibrotic therapeutics."
            />
          </div>
        </section>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Cardiac Fibrosis Mice",
                "item": "https://www.genetargeting.com/cardiac-fibrosis-mice"
              }
            ]
          })
        }}
