/**
 * SEO Metadata for Tissue Specific Cre Lines
...
export const metadata: Metadata = {
  title: 'Tissue Specific Cre Lines | ingenious targeting laboratory',
  description: 'Tissue Specific Cre Lines from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
  alternates: {
    canonical: 'https://www.genetargeting.com/tissue-specific-cre-lines',
  },
  openGraph: {
    title: 'Tissue Specific Cre Lines | ingenious targeting laboratory',
    description: 'Tissue Specific Cre Lines from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
    url: 'https://www.genetargeting.com/tissue-specific-cre-lines',
...
export const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Tissue Specific Cre Lines", item: "https://www.genetargeting.com/tissue-specific-cre-lines" }
  ],
};
