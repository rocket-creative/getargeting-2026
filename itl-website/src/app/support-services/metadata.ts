...
export const metadata: Metadata = {
  title: 'Support Services | ingenious targeting laboratory',
  description: 'Support Services from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
  alternates: {
    canonical: 'https://www.genetargeting.com/support-services',
  },
  openGraph: {
    title: 'Support Services | ingenious targeting laboratory',
    description: 'Support Services from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
    url: 'https://www.genetargeting.com/support-services',
...
export const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Support Services", item: "https://www.genetargeting.com/support-services" }
  ],
};
