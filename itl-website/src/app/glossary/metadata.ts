...
export const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Glossary", item: "https://www.genetargeting.com/glossary" }
  ],
};
