...
export const metadata: Metadata = {
  title: 'ROSA26 Locus | ingenious targeting laboratory',
  description: 'ROSA26 Locus from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
  alternates: {
    canonical: 'https://www.genetargeting.com/rosa26',
  },
  openGraph: {
    title: 'ROSA26 Locus | ingenious targeting laboratory',
    description: 'ROSA26 Locus from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
    url: 'https://www.genetargeting.com/rosa26',
...
export const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "ROSA26 Locus", item: "https://www.genetargeting.com/rosa26" }
  ],
};
