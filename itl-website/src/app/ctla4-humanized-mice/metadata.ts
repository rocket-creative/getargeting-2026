/**
 * SEO Metadata for CTLA4 Humanized Mice
...
export const metadata: Metadata = {
  title: 'CTLA4 Humanized Mice | ingenious targeting laboratory',
  description: 'CTLA4 Humanized Mice from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
  alternates: {
    canonical: 'https://www.genetargeting.com/ctla4-humanized-mice',
  },
  openGraph: {
    title: 'CTLA4 Humanized Mice | ingenious targeting laboratory',
    description: 'CTLA4 Humanized Mice from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
    url: 'https://www.genetargeting.com/ctla4-humanized-mice',
...
export const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "CTLA4 Humanized Mice", item: "https://www.genetargeting.com/ctla4-humanized-mice" }
  ],
};
