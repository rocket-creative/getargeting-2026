      ...
      <main id="main-content">
        ...
        <section style={{ backgroundColor: '#f8f9fa', padding: '50px 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <LabSignalsSignup 
              variant="card"
              title="Preclinical Efficacy Insights"
              description="Get expert guidance on therapeutic testing, model validation, and translational research from PhD scientists."
            />
          </div>
        </section>
