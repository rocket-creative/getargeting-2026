/**
 * SEO Metadata for PD1 Humanized Mice
...
export const metadata: Metadata = {
  title: 'PD1 Humanized Mice | ingenious targeting laboratory',
  description: 'PD1 Humanized Mice from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
  alternates: {
    canonical: 'https://www.genetargeting.com/pd1-humanized-mice',
  },
  openGraph: {
    title: 'PD1 Humanized Mice | ingenious targeting laboratory',
    description: 'PD1 Humanized Mice from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
    url: 'https://www.genetargeting.com/pd1-humanized-mice',
...
export const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "PD1 Humanized Mice", item: "https://www.genetargeting.com/pd1-humanized-mice" }
  ],
};
