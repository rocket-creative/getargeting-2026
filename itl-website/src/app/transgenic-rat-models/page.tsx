...
// FAQ Data
const faqData = [
  { question: "How stable are transgenic rat lines across generations?", answer: "Single copy transgenic lines typically show stable inheritance and consistent expression across multiple generations. Multi copy lines may show variable copy number transmission, but usually stabilize by F1 generation. Expression stability depends substantially on integration site and transgene design." },
  { question: "Can transgenic rats carry BAC inserts exceeding 150 kilobases?", answer: "Yes, BAC transgenic rats successfully integrate BAC clones spanning 100 to 200 kilobases. Integration efficiency may decrease slightly with increasing insert size, but robust transgenic lines are reliably generated. Integration site characterization confirms proper integration." },
  { question: "Can transgenic rats express multiple transgenes simultaneously?", answer: "Separate injection rounds can generate transgenic lines each carrying different transgenes. Crossing such lines generates animals expressing multiple transgenes. Alternatively, bicistronic cassettes using IRES or 2A sequences permit simultaneous expression from single transgene." }
];
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Transgenic Rat Models",
                "item": "https://www.genetargeting.com/transgenic-rat-models"
              }
            ]
          })
        }}
