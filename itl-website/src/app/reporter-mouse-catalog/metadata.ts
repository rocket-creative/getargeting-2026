/**
 * SEO Metadata for Reporter Mouse Catalog
...
export const metadata: Metadata = {
  title: 'Reporter Mouse Catalog | ingenious targeting laboratory',
  description: 'Reporter Mouse Catalog from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
  alternates: {
    canonical: 'https://www.genetargeting.com/reporter-mouse-catalog',
  },
  openGraph: {
    title: 'Reporter Mouse Catalog | ingenious targeting laboratory',
    description: 'Reporter Mouse Catalog from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
    url: 'https://www.genetargeting.com/reporter-mouse-catalog',
...
export const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Reporter Mouse Catalog", item: "https://www.genetargeting.com/reporter-mouse-catalog" }
  ],
};
