...
export const metadata: Metadata = {
  title: 'Rat Models | ingenious targeting laboratory',
  description: 'Rat Models from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
  alternates: {
    canonical: 'https://www.genetargeting.com/rat-models',
  },
  openGraph: {
    title: 'Rat Models | ingenious targeting laboratory',
    description: 'Rat Models from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
    url: 'https://www.genetargeting.com/rat-models',
...
export const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Rat Models", item: "https://www.genetargeting.com/rat-models" }
  ],
};
