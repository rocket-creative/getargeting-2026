...
const faqData = [
  ...
  { question: "How long does it take to receive a quote?", answer: "Quotes are typically delivered within 2-3 business days after receiving your request. For complex projects requiring additional technical review, we'll provide an estimated timeline for quote delivery. Urgent requests can be prioritized for expedited quote delivery when needed." },
  ...
  { question: "Can I get a quote for partial services?", answer: "Yes. ITL provides quotes for partial services including targeting vector only, ES cell targeting only, microinjection only, or other partial services. Pricing is based on the specific scope of work requested. Contact ITL to discuss your partial service needs." },
  { question: "What happens after I receive my quote?", answer: "After receiving your quote, ITL's team is available to discuss any questions or concerns. We can adjust project scope, explore alternative approaches, or provide additional detail about any aspect of the proposed work. Our goal is to ensure you have all the information needed to make informed decisions." }
];
