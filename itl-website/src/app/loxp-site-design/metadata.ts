/**
 * SEO Metadata for LoxP Site Design
...
export const metadata: Metadata = {
  title: 'LoxP Site Design | ingenious targeting laboratory',
  description: 'LoxP Site Design from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
  alternates: {
    canonical: 'https://www.genetargeting.com/loxp-site-design',
  },
  openGraph: {
    title: 'LoxP Site Design | ingenious targeting laboratory',
    description: 'LoxP Site Design from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
    url: 'https://www.genetargeting.com/loxp-site-design',
...
export const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "LoxP Site Design", item: "https://www.genetargeting.com/loxp-site-design" }
  ],
};
