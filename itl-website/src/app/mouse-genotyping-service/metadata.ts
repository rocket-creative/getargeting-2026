/**
 * SEO Metadata for Mouse Genotyping Service
...
export const metadata: Metadata = {
  title: 'Mouse Genotyping Service | ingenious targeting laboratory',
  description: 'Mouse Genotyping Service from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
  alternates: {
    canonical: 'https://www.genetargeting.com/mouse-genotyping-service',
  },
  openGraph: {
    title: 'Mouse Genotyping Service | ingenious targeting laboratory',
    description: 'Mouse Genotyping Service from ingenious targeting laboratory. Custom mouse model engineering since 1998.',
    url: 'https://www.genetargeting.com/mouse-genotyping-service',
...
export const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Mouse Genotyping Service", item: "https://www.genetargeting.com/mouse-genotyping-service" }
  ],
};
