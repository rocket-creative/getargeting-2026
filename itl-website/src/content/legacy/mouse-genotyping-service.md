---
legacy_url: "https://www.genetargeting.com/mouse-genotyping-service"
new_build_url: "/mouse-genotyping-service/"
url_handling: "reuse"
...
The service fee per tail includes DNA extraction, PCR, gel analysis, and data report. We can also provide a more customized genotyping service involving PCR assay development and primer design.

## Our Step-by-Step Process

1. **ingenious Designed Primers** - Because we already performed the initial genotyping on your project, we may already have the relevant primers for running your genotyping assay.

2. **DNA Extraction** - DNA is then extracted from every sample you send.

3. **PCR Amplification** - A small amount of DNA from every sample is used for PCR analysis.
...
7. **Free Re-Runs** - If a genotype cannot be determined with 100% certainty, we will re-run it free of charge.
...
Your tail tips should be placed individually in tubes and capped tightly, and either frozen in dry ice or immersed in 70-95% ethanol as soon as possible after the tail tips have been collected.
