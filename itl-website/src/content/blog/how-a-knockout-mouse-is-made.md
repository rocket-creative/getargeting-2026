...
legacy_url: "https://www.genetargeting.com/ingenious-blog/how-a-knockout-mouse-is-made"
author: "ingenious"
---

![](https://uploads-ssl.webflow.com/665dc660af52559c0ed6ec8b/667b965de9143c2ed2a8468e_How-A-Knockout-Mouse-Is-Made-768x427-1.jpeg)
## How a Knockout Mouse is Made – What is the knockout procedure?
...
## Which techniques are commonly used for gene knockout in mice?

#### Gene Targeting – A Method for Creating a Knockout Mouse Using ES Cells

How a knockout mouse is made depends on the method used for mutating the mouse gene of study. The homologous recombination process is a robust method researchers can use that allows for specific gene targeting of large genomic regions. This method involves the introduction of an artificial gene sequence that is directly targeted to the specific gene sequence of interest by way of a homologous recombination vector, thus the term “homologous recombination.” The homologous sequences in the vector are positioned to flank the existing gene on both sides (“upstream” and “downstream”). In the ES cell, the cellular process of homologous recombination takes over, identifying the matching parts of the sequence and supporting replacement of the original piece of DNA with the engineered artificial gene sequence, hence knocking out the wild type gene.

#### Utilizing CRISPR/Cas9 Technology to Make a Knockout Mouse Model
...
### Knockout Mice Utilizing ES Cells:
...
#### Identifying Cells that Contain the Knockout Gene
...
#### Embryo Injection / Electroporation
