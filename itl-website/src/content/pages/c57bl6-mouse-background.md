...
extracted: "2026-01-09T17:03:03.197Z"
---

# C57BL/6 Mouse Background | C57BL/6J vs C57BL/6N | Ingenious Targeting Laboratory

**Url: /c57bl6-mouse-background**

**Meta Description: C57BL/6 mouse strain background for gene targeting. Compare C57BL/6J and C57BL/6N substrains. Expert guidance on strain selection since 1998.**

**Primary Keyword: C57BL/6 mouse**

**Secondary Keywords: C57BL/6J, C57BL/6N, mouse strain background, B6 mouse**
...
Understanding the differences between C57BL/6 substrains is essential for experimental design. The two major substrains, C57BL/6J and C57BL/6N, diverged decades ago and carry distinct genetic variants that affect metabolism, behavior, and other phenotypes. Selecting the appropriate substrain ensures your model aligns with published literature and avoids confounding variables.
...
rd8 retinal mutation

Absent

Present in some colonies

IKMC allele compatibility

Requires backcrossing
...
Zhou W, Zhang J, Chowdhury NU, Norlander AE, Toki S, Abney M, Rusznak M, Gibson-Corley KN, Cook DP, Newcomb DC, Peebles RS Jr. 2025. [PGI2 signaling metabolically reprograms CD4 Th2 cells and represses allergic airway inflammation](https://pubmed.ncbi.nlm.nih.gov/40587812/). *J Immunol* **9**(214): 2270-2280
...
- (/129-strain-mouse-background)
- (/fvb-mouse-background)
...
**What is the difference between C57BL/6J and C57BL/6N?**
...
**Why is C57BL/6 the most commonly used strain background?**
...
**Can I switch my model to a different strain background later?**
...
## Strain Background Selection Considerations

### Research Application Alignment

When selecting a C57BL/6 substrain, consider how your research application aligns with published literature. If your field predominantly uses C57BL/6J models, maintaining consistency with existing literature may outweigh substrain specific advantages. Conversely, if metabolic phenotypes are central to your research, C57BL/6N may provide advantages.

For metabolic disease research, the functional Nnt gene in C57BL/6N can provide more physiologically relevant insulin secretion responses. For behavioral studies, substrain differences in anxiety and exploratory behavior should be considered when interpreting results.

### Breeding Performance

Both C57BL/6J and C57BL/6N demonstrate excellent breeding performance, though individual lines may show variation. When generating conditional alleles requiring extensive breeding with Cre driver lines, substrain compatibility should be verified. Most commonly used Cre driver lines are maintained on C57BL/6J backgrounds.

Ingenious Targeting Laboratory can provide guidance on substrain selection based on your specific research requirements and breeding plans.
...
- Word count ~1,800 (appropriate for strain background page)