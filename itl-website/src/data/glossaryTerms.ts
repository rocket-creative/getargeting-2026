...
export const glossaryTerms: GlossaryTerm[] = [
  ...
  {
    term: "Embryonic Stem (ES) Cell Targeting",
    slug: "es-cell-targeting",
    definition: "A foundational technique in mouse genetics that enables the introduction of precise genetic modifications into the genome of pluripotent embryonic stem cells, which can then be used to generate chimeric mice.",
    category: "Vectors, ES Cells & Delivery",
  },
  {
    term: "Blastocyst Injection / Chimera Production",
    slug: "blastocyst-injection-chimera",
    definition: "The process of introducing genetically modified embryonic stem cells into a developing mouse blastocyst to create a chimera—an organism composed of cells from both the host embryo and the engineered ES cells.",
    category: "Vectors, ES Cells & Delivery",
  },
  {
