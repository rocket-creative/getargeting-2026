Phenotyping Services | Mouse Model Characterization | ITL

Url: /phenotyping-services
Meta Description: Comprehensive mouse phenotyping services including histopathology, clinical chemistry, behavioral testing, and disease specific phenotyping. Since 1998.
Primary Keyword: mouse phenotyping services
Secondary Keywords: phenotyping mouse model, mouse characterization, histopathology mouse, behavioral phenotyping
Word Count: 1400
...
What types of phenotyping services does ITL provide?
ITL provides comprehensive phenotyping services including metabolic phenotyping (glucose tolerance, insulin tolerance, body composition, metabolic cages), cardiovascular phenotyping (echocardiography, blood pressure, ECG), behavioral phenotyping (open field, elevated plus maze, rotarod, Morris water maze, fear conditioning), and immune phenotyping (flow cytometry, cytokine profiling).
How do you design a phenotyping study?
Phenotyping study design includes determining appropriate cohort sizes based on expected phenotype and statistical requirements, selecting age at analysis (considering developmental timing and disease progression), sex considerations (males vs females, or both), appropriate controls (wild-type littermates, vehicle-treated controls), and timeline planning for longitudinal studies.
What is included in phenotyping service deliverables?
Phenotyping service deliverables include comprehensive data reports with quantitative results, statistical analysis comparing experimental groups to controls, histological images and analysis when applicable, functional assessment results (behavioral, metabolic, cardiovascular), and interpretation guidance for understanding results in context of your research question.
Can phenotyping be performed on existing mouse models?
Yes. ITL can perform phenotyping on models you already have, models generated by ITL, or models obtained from other sources. We work with you to design appropriate phenotyping strategies based on your model type, research question, and expected phenotypes.
Start Your Project
